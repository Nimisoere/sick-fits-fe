...
})(["position:relative;.count{display:block;position:relative;transition:all 0.4s;backface-visibility:hidden;}.count-enter{transform:scale(4);}.count-enter-active{transform:rotateX('0')}.count-exit{top:0;position:absolute;transform:rotateX('0');}.count-exit-active{transform:scale(4);}"]);
...
//# sourceMappingURL=_app.js.05bbf803bd77d3231a8a.hot-update.js.map